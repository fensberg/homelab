// Package console prints what a lifecycle program is doing: the banner between
// phases, and the one-line [ok] / [!!] / [FAIL] marks under it. Shared, so the
// contractor and the lawyer read the same way in a terminal and in a pull
// request comment.
package console
